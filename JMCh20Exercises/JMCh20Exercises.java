...
public class JMCh20Exercises<E>
{
    ...
    {
        int count;
        for ( count = 0; head != null; head = head.getNext() )
        {
            count++;
        }
    ...
    public ListNode<E> add( ListNode<E> head, E value )
    {
        ...
        {
            ListNode<E> fakeHead = head;
            for ( ; fakeHead.getNext() != null; fakeHead.getNext() )
            {
                fakeHead = fakeHead.getNext();
            }
            fakeHead.setNext( new ListNode<E>( value, null ) );
        }
    ...
    public ListNode<E> reverseList( ListNode<E> head )
    {
        ...
        // traverses through the list, and puts it after the one before it
        for ( ListNode<E> b = head; b != null; b = b.getNext() )
        {
            a = new ListNode<E>( b.getValue(), a );
        }
    ...
    public ListNode<String> concatenateStrings( ListNode<String> head )
    {
        ...
        ListNode<String> headOfNewList = null;
        String c = "";

        for ( ListNode<String> b = head; b != null; b = b.getNext() )
        {

            c += b.getValue();
            ListNode<String> node = new ListNode<String>( c, null );
    ...
    public ListNode<E> rotate( ListNode<E> head )
    {
        ...
        if ( head2 == null || head.getNext() == null )
        {
            return head;
        }
        ListNode<E> finalHead = head.getNext();
     ...
     */
    public ListNode<String> insertInOrder(
        ListNode<String> head,
        String s )
    {
        ListNode<String> a = head;
        ListNode<String> b = null;
        ListNode<String> prev = null;
        int count = 0;

        while ( a != null && s.compareTo( (String)a.getValue() ) > 0 )
        {
            b = a;
            a = a.getNext();

        }
        if ( a != null && ( s.equals( a.getValue() ) ) )
            return head;
        if ( b == null )
        {
            head = new ListNode<String>( s, a );
        }

        else
        {
            b.setNext( new ListNode<String>( s, a ) );
        }
    ...
    public static void sort( ListNode<String> head )
    {
        ...
        while ( a != null )
        {
            ...
            ListNode<String> min = a;
            ListNode<String> t = a.getNext();
            while ( t != null )
            {
                // System.out.println( min );
                if ( t.getValue().compareTo( (String)min.getValue() ) < 0 )
                    min = t;
                // System.out.println( min );

                t = t.getNext();
            }
            String temp = min.getValue();
            min.setValue( a.getValue() );
    ...
    public static ListNode2<Integer> removeMax( ListNode2<Integer> head )
    {
        if ( head != null )
        {
            ListNode2<Integer> a = head.getNext();
            ListNode2<Integer> max = head;

            while ( a != null && a.getNext() != null )
            {
                if ( ( (Integer)a.getValue() )
                    .compareTo( (Integer)max.getValue() ) > 0 )
                    max = a;
                a = a.getNext();
            }

            ListNode2<Integer> b = max.getNext();
            ...
            {
                max.getPrevious().setNext( b );
            }
            if ( b != null )
            {
                b.setPrevious( max.getPrevious() );
            }
        }
        return head;
