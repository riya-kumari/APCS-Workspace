 ...
 * @version Nov 3, 2018
 * @author Period: 5
 * @author Assignment: JMCh12_Exercises
 */
public class JMCh12Exercises
{
    ...
    public boolean[] prob2abcdTrueFalse()
    {
        ...
        // a - false, the following array has 100 elements
        // b - true, it autoboxes it into an object
        // c - true, if it doesn't fall in the valid range then it returns an
        // IndexOutOfBounds error
        // d - false, A one dimensional array object doesn't have a length
        // method. It does have length but it isn't a method.
    }
    ...
    {
        char[] ch = { 'r', 'r', 'r', 'p', 'p', 'p', 'p', 'p', 's', 's',
            's', 's', 's', 's', };
        char random = ch[(int)( Math.random() * ch.length )];
        return random;
    }
    ...
    public String whatDoesMysteryCountCount()
    {
        ...
        String answer = mCount
            + " It counts the number of zeros in the array before it finds a number that isn't zero.";
    ...
    {
        if ( m < n ) // swaps them if necessary to make m > n
        {
            int temp = m;
            m = n;
            n = temp;
    ...
    // D - 2 H - 4 L - 1 P - 3 T - 1
    //
    public static int[] letterScores = { 1, 3, 3, 2, 1, 4, 2, 4, 1, 8, 5,
        1, 3, 1, 3, 3, 10, 1, 1, 1, 1, 4, 4, 8, 4, 10 };
    ...
    public boolean[] prob11abcdeTrueFalse()
    {
        ...
        // a- true, There can be two identical references.
        // b- true, The arraylist just holds objects.
        // c - false, the remove method removes the object and if the object is
        // not needed Java's garbage collector destroys it
        // d - false, The add method does not make a copy of the object
        // e - true, a = new ArrayList<String>(10); then b = a; Now both a and b
    ...
    {
        ArrayList<String> a = new ArrayList<String>( list.size() + 1 );
    ...
    public boolean isMedian( double[] sample, double m )
    {
        ...
        return before == after; // TODO fix this!!
    }
    ...
    public static double averageTopTwo( int[] scores )
    {
        ...
        int average = ( scores[iMax1] + scores[iMax2] ) / 2;
        return average;
    }
    ...
    public static void main( String[] args )
    {
        ...
        do
        {
            ...
            System.out
                .println( "   (7) 12-6 whatDoesMysteryCountCount()" );
            System.out.println(
                "   (8) 12-7 makePythagoreanTriple( int m, int n )" );
            System.out.println( "   (9) 12-8 createWedge(int n)" );
            System.out
                .println( "   (A) 12-9 computeScore( String word )" );
            System.out
                .println( "   (B) 12-11abcde prob11abcdeTrueFalse()" );
            System.out.println(
                "   (C) 12-12 reverse( ArrayList<String> list )" );
            System.out.println(
            ...
            System.out
                .println( "   (H) 12-20 averageTopTwo( int[] scores )" );
            System.out.println(
                "   (I) 12-26 liesOnDiagonal( int[][] matrix, int i, int j )" );
            System.out
                .println( "   (J) 12-27 positiveMax( double[][] m )" );
            System.out.println(
            ...
            if ( response.length() > 0 )
            {
                ...
                switch ( response.charAt( 0 ) )
                {
                    ...
                    case '7':
                        System.out
                            .println( "whatDoesMysteryCountCount() = "
                    ...
                    case 'g':
                        ...
                        double median = 5.6;
                        System.out.println(
                            "isMedian(" + Arrays.toString( sample ) + ", "
                                + median + ") = "
                    ...
                    case 'i':
                        ...
                        int i = 1;
                        int j = 2;
                        System.out.println( "liesOnDiagonal(" + i + ", "
                            + j + ") = "
